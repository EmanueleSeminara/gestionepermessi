			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a id="changeStatoLink_#_${utenteItem.id }" class="btn btn-outline-danger btn-sm link-for-modal" data-bs-toggle="modal" data-bs-target="#resetPasswordModal"  >Reset Password</a>
										</td>
									</tr>
								</c:forEach>
			                </tbody>
