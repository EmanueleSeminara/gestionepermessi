...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .antMatchers("/dipendente/edit/**", "dipendente/update").hasRole("BO_USER")
         .antMatchers("/richiestapermesso/cambiastato", "richiestapermesso/search").hasRole("BO_USER")
         .antMatchers("richiestapermesso/edit/**", "richiestapermesso/insert", "richiestapermesso/searchpersonal").hasRole("DIPENDENTE_USER")
